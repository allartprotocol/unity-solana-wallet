...
namespace Solnet.Rpc
{
    ...
    public class SolanaRpcClient : JsonRpcClient
    {
        ...
        { return GetAccountInfoAsync(pubKey).Result; }
        ...
        public async Task<RequestResult<ResponseValue<SignatureStatus[]>>> GetSignatureStatuses(string pubKey)
        {
            return await SendRequestAsync<ResponseValue<SignatureStatus[]>>("getSignatureStatuses", new List<object> { new string[] { pubKey} });
        }
        ...
        public async Task<RequestResult<string>> RequestAirdropAsync(string pubKey, ulong lamports, ECommitment commitment = ECommitment.Finalized)
        {
        ...
        public RequestResult<string> RequestAirdrop(string pubKey, ulong lamports, ECommitment commitment = ECommitment.Finalized)
