...
namespace Solnet.Wallet
{
    ...
    public class Wallet
    {
        ...
        /// <param name="passphrase">The passphrase.</param>
        /// <param name="seedMode">The seed generation mode.</param>
        public Wallet(string mnemonicWords, BIP39Wordlist wordlist = BIP39Wordlist.English, string passphrase = "", SeedMode seedMode = SeedMode.Ed25519Bip32)
        {
        ...
        public byte[] DeriveMnemonicSeed()
        {
            ...
            return WalletKeyPair.GenerateSeedFromMnemonic(Mnemonic);
        }
        ...
        private void InitializeFirstAccount()
        {
            ...
            {
                var (privateKey, publicKey) = Ed25519Extensions.EdKeyPairFromSeed(_seed.Slice(0, 32));//[..32]);
